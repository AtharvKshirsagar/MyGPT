...
from mygpt.utils import set_seed, setup_logging, CfgNode as CN
...
class AdditionDataset(Dataset):
    ...
    def get_default_config():
        C = CN()
        #Number of digits is two below but you can change it but you will se that it takes more time to attain 100 percent accuracy.
        C.ndigit = 2
        return C
...
# Add the following code after the trainer.run() line
losses = trainer.get_train_losses()
